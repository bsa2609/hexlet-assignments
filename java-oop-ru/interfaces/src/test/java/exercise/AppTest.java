...
class AppTest {
    ...
    void testReversedSequence1() {
        String line = "abcdef";
        ReversedSequence charSecuence = new ReversedSequence(line);
        String result = charSecuence.toString();
    ...
    void testReversedSequence2() {
        String line = "abcdef";
        ReversedSequence charSecuence = new ReversedSequence(line);
        char result = charSecuence.charAt(1);
        char expected = 'e';
        assertThat(result).isEqualTo(expected);
    }
    ...
    void testReversedSequence3() {
        String line = "abcdef";
        ReversedSequence charSecuence = new ReversedSequence(line);
        int result = charSecuence.length();
        int expected = 6;
        assertThat(result).isEqualTo(expected);
    }
    ...
    void testReversedSequence4() {
        String line = "abcdef";
        ReversedSequence charSecuence = new ReversedSequence(line);
        String result = charSecuence.subSequence(1, 4).toString();
        String expected = "edc";
        assertThat(result).isEqualTo(expected);
    }
    // END
